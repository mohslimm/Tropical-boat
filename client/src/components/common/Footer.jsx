      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            <div style={{ marginBottom: '1rem' }}>
              <span style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '2rem', fontWeight: 600, color: 'var(--gold)' }}>Tropical Boat</span>
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <a href="mailto:info@tropicalboat.com" style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>info@tropicalboat.com</a>
        ...
        <div style={{ paddingTop: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
            © {year} Tropical Boat. All rights reserved.
          </p>
